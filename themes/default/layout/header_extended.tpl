...
<div class="container1 col-md-14">
[THEME_ERROR_INFO]
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="{NV_BASE_SITEURL}uploads/img/Sapa.jpg" alt="Sapa" style="width:100%;">
      </div>

      <div class="item">
        <img src="{NV_BASE_SITEURL}uploads/img/Huế.jpg" alt="Hue" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="{NV_BASE_SITEURL}uploads/img/Nui-phu-si.jpg" alt="NuiPhuSi" style="width:100%;">
      </div>

      <div class="item">
        <img src="{NV_BASE_SITEURL}uploads/img/Na Hang.jpg" alt="NaHang" style="width:100%;">
      </div>
    </div>
